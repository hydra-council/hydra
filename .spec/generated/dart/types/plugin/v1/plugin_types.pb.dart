...
/// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
///  Load plugin
class LoadPluginRequest extends $pb.GeneratedMessage {
  factory LoadPluginRequest({
    $core.String? pluginPath,
  }) {
    final $result = create();
    if (pluginPath != null) {
  ...
  LoadPluginRequest._() : super();
  factory LoadPluginRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory LoadPluginRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LoadPluginRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'plugin_types.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'pluginPath', protoName: 'pluginPath')
  ...
  LoadPluginRequest clone() => LoadPluginRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LoadPluginRequest copyWith(void Function(LoadPluginRequest) updates) => super.copyWith((message) => updates(message as LoadPluginRequest)) as LoadPluginRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static LoadPluginRequest create() => LoadPluginRequest._();
  LoadPluginRequest createEmptyInstance() => create();
  static $pb.PbList<LoadPluginRequest> createRepeated() => $pb.PbList<LoadPluginRequest>();
  @$core.pragma('dart2js:noInline')
  static LoadPluginRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<LoadPluginRequest>(create);
  static LoadPluginRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get pluginPath => $_getSZ(0);
  @$pb.TagNumber(1)
  set pluginPath($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasPluginPath() => $_has(0);
  @$pb.TagNumber(1)
  void clearPluginPath() => clearField(1);
}

class LoadPluginResponse extends $pb.GeneratedMessage {
  factory LoadPluginResponse({
    $core.String? status,
  }) {
    final $result = create();
    if (status != null) {
  ...
  LoadPluginResponse._() : super();
  factory LoadPluginResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory LoadPluginResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LoadPluginResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'plugin_types.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  LoadPluginResponse clone() => LoadPluginResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LoadPluginResponse copyWith(void Function(LoadPluginResponse) updates) => super.copyWith((message) => updates(message as LoadPluginResponse)) as LoadPluginResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static LoadPluginResponse create() => LoadPluginResponse._();
  LoadPluginResponse createEmptyInstance() => create();
  static $pb.PbList<LoadPluginResponse> createRepeated() => $pb.PbList<LoadPluginResponse>();
  @$core.pragma('dart2js:noInline')
  static LoadPluginResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<LoadPluginResponse>(create);
  static LoadPluginResponse? _defaultInstance;
