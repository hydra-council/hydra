...
class ExtensionRepo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExtensionRepo', package: const $pb.PackageName(_omitMessageNames ? '' : 'manga.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'repoName', protoName: 'repoName')
    ..aOS(2, _omitFieldNames ? '' : 'repoUrl', protoName: 'repoUrl')
    ..aOS(3, _omitFieldNames ? '' : 'jsonRepoUrl', protoName: 'jsonRepoUrl')
    ..aOS(4, _omitFieldNames ? '' : 'version')
    ..aOS(5, _omitFieldNames ? '' : 'manifestVersion')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  void clearRepoUrl() => clearField(2);

  @$pb.TagNumber(3)
  $core.String get jsonRepoUrl => $_getSZ(2);
  @$pb.TagNumber(3)
  set jsonRepoUrl($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasJsonRepoUrl() => $_has(2);
  @$pb.TagNumber(3)
  void clearJsonRepoUrl() => clearField(3);
  ...
  @$pb.TagNumber(5)
  $core.String get manifestVersion => $_getSZ(4);
  @$pb.TagNumber(5)
  set manifestVersion($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasManifestVersion() => $_has(4);
  @$pb.TagNumber(5)
  void clearManifestVersion() => clearField(5);
}
...
class Extension extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Extension', package: const $pb.PackageName(_omitMessageNames ? '' : 'manga.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'extensionName', protoName: 'extensionName')
    ..aOS(2, _omitFieldNames ? '' : 'manifestVersion')
    ..aOS(3, _omitFieldNames ? '' : 'version')
    ..aOS(4, _omitFieldNames ? '' : 'mediaType')
    ..aOS(5, _omitFieldNames ? '' : 'repoUrl', protoName: 'repoUrl')
    ..aOS(6, _omitFieldNames ? '' : 'scriptUrl', protoName: 'scriptUrl')
    ..aOS(7, _omitFieldNames ? '' : 'metaDataUrl', protoName: 'metaDataUrl')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.String get extensionName => $_getSZ(0);
  @$pb.TagNumber(1)
  set extensionName($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasExtensionName() => $_has(0);
  @$pb.TagNumber(1)
  void clearExtensionName() => clearField(1);

  @$pb.TagNumber(2)
  $core.String get manifestVersion => $_getSZ(1);
  @$pb.TagNumber(2)
  set manifestVersion($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasManifestVersion() => $_has(1);
  @$pb.TagNumber(2)
  void clearManifestVersion() => clearField(2);
  ...
  @$pb.TagNumber(5)
  $core.String get repoUrl => $_getSZ(4);
  @$pb.TagNumber(5)
  set repoUrl($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasRepoUrl() => $_has(4);
  @$pb.TagNumber(5)
  void clearRepoUrl() => clearField(5);

  @$pb.TagNumber(6)
  $core.String get scriptUrl => $_getSZ(5);
  @$pb.TagNumber(6)
  set scriptUrl($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
  $core.bool hasScriptUrl() => $_has(5);
  @$pb.TagNumber(6)
  void clearScriptUrl() => clearField(6);

  @$pb.TagNumber(7)
  $core.String get metaDataUrl => $_getSZ(6);
  @$pb.TagNumber(7)
  set metaDataUrl($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(7)
  $core.bool hasMetaDataUrl() => $_has(6);
  @$pb.TagNumber(7)
  void clearMetaDataUrl() => clearField(7);
}
