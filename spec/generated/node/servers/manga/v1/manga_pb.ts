...
export class ExtensionRepo extends Message<ExtensionRepo> {
  /**
   * @generated from field: string repoName = 1;
   */
  repoName = "";

  /**
   * @generated from field: string repoUrl = 2;
   */
  repoUrl = "";

  /**
   * @generated from field: string jsonRepoUrl = 3;
   */
  jsonRepoUrl = "";
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "repoName", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "repoUrl", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "jsonRepoUrl", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "version", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 5, name: "manifest_version", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
export class Extension extends Message<Extension> {
  /**
   * @generated from field: string extensionName = 1;
   */
  extensionName = "";
  ...
  /**
   * @generated from field: string scriptUrl = 6;
   */
  scriptUrl = "";

  /**
   * @generated from field: string metaDataUrl = 7;
   */
  metaDataUrl = "";
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "extensionName", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "manifest_version", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "version", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "media_type", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 5, name: "repoUrl", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 6, name: "scriptUrl", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 7, name: "metaDataUrl", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
