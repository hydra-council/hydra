...
@$core.Deprecated('Use loadPluginRequestDescriptor instead')
const LoadPluginRequest$json = {
  '1': 'LoadPluginRequest',
  '2': [
    {'1': 'pluginPath', '3': 1, '4': 1, '5': 9, '10': 'pluginPath'},
  ],
};

/// Descriptor for `LoadPluginRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List loadPluginRequestDescriptor = $convert.base64Decode(
    'ChFMb2FkUGx1Z2luUmVxdWVzdBIeCgpwbHVnaW5QYXRoGAEgASgJUgpwbHVnaW5QYXRo');

@$core.Deprecated('Use loadPluginResponseDescriptor instead')
const LoadPluginResponse$json = {
  '1': 'LoadPluginResponse',
  '2': [
    {'1': 'status', '3': 1, '4': 1, '5': 9, '10': 'status'},
  ],
};

/// Descriptor for `LoadPluginResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List loadPluginResponseDescriptor = $convert.base64Decode(
    'ChJMb2FkUGx1Z2luUmVzcG9uc2USFgoGc3RhdHVzGAEgASgJUgZzdGF0dXM=');
